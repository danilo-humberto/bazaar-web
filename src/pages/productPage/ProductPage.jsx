...
export default function ProductPage() {
  const [lista] = useState([
    ...
    { id: 1, codigo: '001', titulo: 'Produto 1', descricao: 'Descrição do Produto 1', valorUnitario: '100,00', tempoEntregaMinimo: '2 dias', tempoEntregaMaximo: '5 dias', imagem: 'url_da_imagem_1' },
    { id: 2, codigo: '002', titulo: 'Produto 2', descricao: 'Descrição do Produto 2', valorUnitario: '200,00', tempoEntregaMinimo: '3 dias', tempoEntregaMaximo: '6 dias', imagem: 'url_da_imagem_2' }
  ]);
